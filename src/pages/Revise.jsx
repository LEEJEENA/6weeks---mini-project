...
import { __addComment, __getComment, __deleteComment, __editComment} from "../redux/modules/melonSlice"
...
function Revise (){
    ...
    return (
        <>
            <input placeholder="이름" value={comment.username}
            type="text" name="username" onChange={onChangeInputHandler}/>

            <input placeholder="댓글을 입력하세요" value={comment.content}
            name="content" type="text" onChange={onChangeInputHandler}/>
                        ...
                        if(comment.todoId == id){
                            return(
                                <div key={comment.id}>
                                    ...
                                    {edit ? (
                                        <>
                                        <textarea type="text" value={target} 
                                        onChange={({ target }) => setTarget(target.value)} />
                                                    
                                        <div>
                                        <button onClick={()=> onClickUdapte(comment.id)}>수정완료</button>
                                        </div>
